class Enter {
  ...
  mousePressed() {
    if (mouseX > this.enterGifx - this.enterGif.width / 2 &&
      ...
      currentState = new Home5(homePageImage3, horseDotComGif2, backgroundHorse2, caring, ourMission, achievements, volunteer, slideshowImages2, screamingHorse, glitchHorse, flask1, curedHorse, boss1, boss2, gun, boss11, boss22);
